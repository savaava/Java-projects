...
public class Aula {
    ...
    public void entra(Studente s){
        if(this.currDim == this.maxPosti){
            System.err.println("Non è possibile eseguire il metodo entra: ");
            System.err.println("L'aula ha raggiunto la capienza massima di studenti: "+this.currDim+"/"+maxPosti);
            return;
        }
    ...
    public void esce(){
        if(this.currDim == 0){
            ...
            System.err.println("L'aula non contiene studenti: "+this.currDim+"/"+maxPosti);
            return;
        }
    ...
    public void getInfoAula(){
        if(this.currDim == 0){
            System.out.println("L'aula non contiene studenti: "+this.currDim+"/"+maxPosti);
            return;
        }
        
        System.out.println("L'aula contiene "+this.currDim+"studenti: ");
