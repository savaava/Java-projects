...
public class TestAeroporto {
    public static void main(String[] args) {        
        ...
        Aeroporto a = new Aeroporto(null);
        for(Aeromobile ai : v)
            a.inserisci(ai);
        a.salvaDOS("salvataggio.bin");
        a.salvaOBJ("salvataggio.ser");
        System.out.println("salvataggio.bin\n"+Aeroporto.leggiDIS("salvataggio.bin"));
        System.out.println("salvataggio.ser\n"+Aeroporto.leggiOBJ("salvataggio.ser"));
